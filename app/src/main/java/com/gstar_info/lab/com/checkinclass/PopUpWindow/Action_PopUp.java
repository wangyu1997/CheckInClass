package com.gstar_info.lab.com.checkinclass.PopUpWindow;
...
public class Action_PopUp extends PopupWindow {
    ...
    protected Button join_btn, quit_btn, cancel_btn;

    public Action_PopUp(boolean state, final Activity mcontext, View.OnClickListener itemsOnClick) {
        ...
        join_btn = (Button) mMenuView.findViewById(R.id.join_btn);
        quit_btn = (Button) mMenuView.findViewById(R.id.quit_btn);
        join_btn.setOnClickListener(itemsOnClick);
        quit_btn.setOnClickListener(itemsOnClick);
